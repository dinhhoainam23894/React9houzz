  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      if (this.props.isImage == true && this.props.isImage) {
        ...
        console.log(slug); // Router.push(`${this.props.currentPath}?photoId=${id}&id=${this.state.project.id}`,`/anh/${nextId}-${nextSlug}`)
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=7.beffb54e9451aed5c0ca.hot-update.js.map
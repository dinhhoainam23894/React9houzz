            ...
            while (1) {
              switch (_context7.prev = _context7.next) {
                case 0:
                  ...
                  if (!(startIndex == 1 && _this.state.backPageUrl != null)) {
                    _context7.next = 7;
                    break;
                  }
              ...
              switch (_context8.prev = _context8.next) {
                ...
                case 3:
                  ...
                  return _axios.default.get(url).then(function (response) {
                    ...
                    _this.setState({
                      ...
                      backPageUrl: data.images.back_page_url
                    });
                ...
                case 6:
                  _axios.default.get(url).then(function (response) {
                    ...
                    _this.listIdea = data.slug;
                    _this.backPageUrl = data.back;
                    _this.currentIndex = _this.listIdea.length - 1;
                    var backImage = _this.listIdea[_this.currentIndex];
                    ...
                    _this.handler(backImage[0], backImage[1]);
                  });
...
//# sourceMappingURL=6.116e4304dfdaaffc5600.hot-update.js.map
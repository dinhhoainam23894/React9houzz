...
function (_React$Component) {
  ...
  _createClass(IdeaComponent, [{
    ...
    key: "dismissModal",
    value: function dismissModal(idea, ideaPath) {
      if (this.props.ideaParams) {
        var params = this.props.ideaParams;
        ...
        console.log(idea, ideaPath); // Router.push(currentPath,asPath)
      }
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement(_layout.default, _extends({}, this.props, {
        ...
        onDismiss: function onDismiss() {
          return _this2.dismissModal(currentPath, asPath);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 107
...
//# sourceMappingURL=6.70eddc88da37ee1ba524.hot-update.js.map
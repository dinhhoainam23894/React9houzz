...
function (_React$Component) {
  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      ...
      } else {// Router.push(`${this.props.currentPath}?photoId=${id}&id=${this.state.project.id}`,`/anh/${nextId}-${nextSlug}`)
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=7.d5fce08e1c6ca8639234.hot-update.js.map
  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      ...
      if (this.props.isImage == true && this.props.isImage) {
        ...
        _routes.Router.push("".concat(this.props.path, "?photoId=").concat(id), "/anh/".concat(nextId, "-").concat(nextSlug));
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=5.dd2fde72277fe9bc51b9.hot-update.js.map
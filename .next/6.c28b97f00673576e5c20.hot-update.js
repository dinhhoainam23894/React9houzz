            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  console.log(_this.props.project.id); // Router.pushRoute(`/du-an/${this.props.project.id}-${this.props.project.slug}`,`/anh/${nextId}-${nextSlug}`)
...
//# sourceMappingURL=6.c28b97f00673576e5c20.hot-update.js.map
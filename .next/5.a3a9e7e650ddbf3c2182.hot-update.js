          ...
          return _regenerator.default.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 8:
                  _routes.Router.push("/y-tuong?photoId=".concat(nextImage.id), "/anh/".concat(nextImage.id, "-").concat(nextImage.slug)); // Router.push(`/$idea?photoId=${nextImage.id}&id=${nextImage.id}&slug=${nextImage.slug}`,`/anh/${nextImage.id}-${nextImage.slug}`)
...
//# sourceMappingURL=5.a3a9e7e650ddbf3c2182.hot-update.js.map
  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      ...
      if (this.props.isImage == true && this.props.isImage) {
        ...
        _routes.Router.push("".concat(this.props.currentPath, "?photoId=").concat(id), "/anh/".concat(nextId, "-").concat(nextSlug));
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=6.22989c303aac5dedff74.hot-update.js.map
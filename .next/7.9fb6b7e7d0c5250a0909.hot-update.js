...
function (_React$Component) {
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  if (currentIndex >= _this.state.listIdea.length - 1) {
  ...
  _createClass(Image, [{
    ...
    key: "getFullImage",
    value: function getFullImage(url, func) {
      var _this3 = this;
      ...
      switch (func) {
        case 'next':
          _axios.default.get(url, {
            ...
            _this3.listIdea = data.slug;
            _this3.nextPageUrl = data.page;
            _this3.currentIndex = 0;
            var nextImage = _this3.listIdea[_this3.currentIndex];
            ...
            _this3.handler(nextImage[0], nextImage[1]);
          });
        ...
        case 'back':
          _axios.default.get(url, {
            ...
            var data = response.data;
            _this3.listIdea = data.slug;
            _this3.backPageUrl = data.back;
            _this3.currentIndex = _this3.listIdea.length - 1;
            var backImage = _this3.listIdea[_this3.currentIndex];
            ...
            _this3.handler(backImage[0], backImage[1]);
          });
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        onClick: function onClick(e) {
          return _this4.nextImage(e, id, slug);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 241
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement("li", {
          ...
          className: "link",
          onClick: function onClick(e) {
            return _this5.changeImage(e, value);
          },
          __source: {
            fileName: _jsxFileName,
            lineNumber: 357
...
//# sourceMappingURL=7.9fb6b7e7d0c5250a0909.hot-update.js.map
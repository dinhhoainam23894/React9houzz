    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      if (this.props.isImage == true && this.props.isImage) {
        ...
        if (this.props.ideaParams) {
          ...
          _routes.Router.push("".concat(this.props.currentPath, "?photoId=").concat(id, "&id=").concat(this.state.project.id, "&slug=").concat(slug), "/anh/".concat(id, "-").concat(slug));
...
//# sourceMappingURL=7.b6df81031bcdd059d423.hot-update.js.map
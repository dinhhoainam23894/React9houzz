    ...
    value: function pushStateUrl(id, slug) {
      if (this.props.ideaParams) {
        ...
        if (this.props.subParams) {
          console.log(this.props); // Router.push(`${this.props.currentPath}?params=${params}&f=${this.props.subParams}&photoId=${id}&slug=${slug}`,`/anh/${id}-${slug}`)
        } else {
          console.log(this.props); // Router.push(`${this.props.currentPath}?params=${params}&photoId=${id}&slug=${slug}`,`/anh/${id}-${slug}`)
        }
      } else {
...
//# sourceMappingURL=7.8dad1638b807ffd90e2b.hot-update.js.map
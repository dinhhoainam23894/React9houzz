...
function (_Component) {
  ...
  _createClass(Project, [{
    ...
    value: function showPhoto(e, id, slug) {
      e.preventDefault();
      __WEBPACK_IMPORTED_MODULE_7__routes__["Router"].push("/project?id=".concat(this.props.id, "&photoId=").concat(id, "&slug=").concat(slug), "/anh/".concat(id, "-").concat(slug));
    }
  }, {
    key: "dismissModal",
    value: function dismissModal(id, slug) {
      __WEBPACK_IMPORTED_MODULE_7__routes__["Router"].pushRoute('project.detail', {
        id: id,
        slug: "".concat(slug)
      });
    }
    ...
    value: function render() {
      ...
      }, " ", project.source_url)), project.more_infos && Object(__WEBPACK_IMPORTED_MODULE_6__libraries_helpers__["a" /* mapObject */])(project.more_infos, function (index, value) {
...
//# sourceMappingURL=5.c107f024ea0ba6afa6c9.hot-update.js.map
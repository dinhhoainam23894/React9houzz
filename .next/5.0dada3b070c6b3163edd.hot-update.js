...
function (_Component) {
  ...
  _createClass(Project, [{
    ...
    value: function showPhoto(e, id, slug) {
      e.preventDefault();
      __WEBPACK_IMPORTED_MODULE_8__routes__["Router"].push("/project?id=".concat(this.props.id, "&photoId=").concat(id, "&slug=").concat(slug), "/anh/".concat(id, "-").concat(slug));
    }
  }, {
    key: "dismissModal",
    value: function dismissModal(id, slug) {
      __WEBPACK_IMPORTED_MODULE_8__routes__["Router"].pushRoute('project.detail', {
        id: id,
        slug: "".concat(slug)
      });
    }
...
//# sourceMappingURL=5.0dada3b070c6b3163edd.hot-update.js.map
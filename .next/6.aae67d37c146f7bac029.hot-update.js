    ...
    value: function pushStateUrl(id, slug) {
      if (this.props.ideaParams) {
        ...
        if (this.props.subParams) {
          console.log('1', this.props); // Router.push(`${this.props.currentPath}?params=${params}&f=${this.props.subParams}&photoId=${id}&slug=${slug}`,`/anh/${id}-${slug}`)
        } else {
          console.log('2', this.props); // Router.push(`${this.props.currentPath}?params=${params}&photoId=${id}&slug=${slug}`,`/anh/${id}-${slug}`)
        }
      } else {
...
//# sourceMappingURL=6.aae67d37c146f7bac029.hot-update.js.map
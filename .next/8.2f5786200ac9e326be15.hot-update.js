            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  console.log(_this.state.project.id);

                  _routes.Router.pushRoute("/du-an/".concat(_this.state.project.id, "-").concat(_this.state.project.slug), "/anh/".concat(nextId, "-").concat(nextSlug));
...
//# sourceMappingURL=8.2f5786200ac9e326be15.hot-update.js.map
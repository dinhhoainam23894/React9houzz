          ...
          return _regenerator.default.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 8:
                  _routes.Router.push("/y-tuong?photoId=".concat(nextImage.id, "&slug=").concat(nextImage.slug), "/anh/".concat(nextImage.id, "-").concat(nextImage.slug)); // Router.push(`/$idea?photoId=${nextImage.id}&id=${nextImage.id}&slug=${nextImage.slug}`,`/anh/${nextImage.id}-${nextImage.slug}`)
...
//# sourceMappingURL=6.74e5ef600909db3c183a.hot-update.js.map
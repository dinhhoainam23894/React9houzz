            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  _routes.Router.push("/project?photoId=".concat(id, "&id=").concat(_this.state.project.id), "/anh/".concat(nextId, "-").concat(nextSlug));
  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      if (isImage == true) {
        ...
        _routes.Router.push("".concat(this.props.path, "?photoId=").concat(id, "&id=").concat(this.state.project.id), "/anh/".concat(nextId, "-").concat(nextSlug));
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=8.d429ba3c91a43cbe2084.hot-update.js.map
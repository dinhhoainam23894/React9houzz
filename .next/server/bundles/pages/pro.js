...
function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      }, this.props.title || '9houz'), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("style", {
...
module.exports = {"name":"create-next-example-app","scripts":{"dev":"node server.js","build":"next build","start":"NODE_ENV=production node server.js"},"dependencies":{"@zeit/next-css":"^0.2.0","@zeit/next-sass":"^0.2.0","axios":"^0.18.0","bootstrap":"^4.1.1","css-loader":"^0.28.11","dotenv":"^6.0.0","es6-promise":"^4.2.4","express":"^4.16.3","font-awesome":"^4.7.0","ionicons":"^4.2.4","isomorphic-fetch":"^2.2.1","jquery":"^3.3.1","lru-cache":"^4.1.3","next":"^6.1.1","next-routes":"^1.4.2","nprogress":"^0.2.0","postcss-loader":"^2.1.6","prop-types":"^15.6.2","raw-loader":"^0.5.1","react":"^16.4.1","react-dom":"^16.4.1","react-infinite":"^0.13.0","react-infinite-scroller":"^1.2.0","react-masonry-component":"^6.2.1","react-modal":"^3.5.1","reactstrap":"^6.3.0","style-loader":"^0.21.0","tunnel-agent":"^0.6.0","universal-cookie":"^2.2.0"},"devDependencies":{"create-next":"^0.1.4","node-sass":"^4.9.2","sass-loader":"^7.0.3"}}
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Pro; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator__ = __webpack_require__("@babel/runtime/regenerator");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react__ = __webpack_require__("react");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_provider_sidebar__ = __webpack_require__("./components/provider-sidebar.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_list_project__ = __webpack_require__("./components/list-project.js");
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  // await this.getValue()
                  $max = 220;
                  $height = __WEBPACK_IMPORTED_MODULE_8_jquery___default()('#readMoreText').css('height', 'auto').height();

                  if ($height < $max) {
                    __WEBPACK_IMPORTED_MODULE_8_jquery___default()("#readMoreBtn").hide();
                  } else {
                    $height = __WEBPACK_IMPORTED_MODULE_8_jquery___default()('#readMoreText').css('height', '220px');
                    $readMore = __WEBPACK_IMPORTED_MODULE_8_jquery___default()("#readMoreBtnText").text();
                    $readLess = __WEBPACK_IMPORTED_MODULE_8_jquery___default()("#readLessBtnText").text();
                    __WEBPACK_IMPORTED_MODULE_8_jquery___default()("#readMoreBtn").text($readMore);
                    __WEBPACK_IMPORTED_MODULE_8_jquery___default()("#readMoreBtn").append("<span class=\"fa fa-angle-down font-15\"></span>");
                    __WEBPACK_IMPORTED_MODULE_8_jquery___default()('#readMoreBtn').click(function () {
                      var $this = __WEBPACK_IMPORTED_MODULE_8_jquery___default()(this);
                      __WEBPACK_IMPORTED_MODULE_8_jquery___default()("#readMoreBtn").text($readMore);
                      ...
                      if ($this.data('expanded') == "yes") {
                        ...
                        __WEBPACK_IMPORTED_MODULE_8_jquery___default()("#readMoreBtn").text($readMore);
                        __WEBPACK_IMPORTED_MODULE_8_jquery___default()("#readMoreBtn").append("<span class=\"fa fa-angle-down font-15\" ></span>");
                        __WEBPACK_IMPORTED_MODULE_8_jquery___default()('#readMoreText').animate({
                          height: '220px'
                        });
                      } else {
                        $this.data('expanded', "yes");
                        __WEBPACK_IMPORTED_MODULE_8_jquery___default()('#readMoreText').css({
                          height: 'auto'
                        });
                        __WEBPACK_IMPORTED_MODULE_8_jquery___default()("#readMoreBtn").text($readLess);
                        __WEBPACK_IMPORTED_MODULE_8_jquery___default()("#readMoreBtn").append("<span class=\"fa fa-angle-up font-15\"></span>");
                      }
                    });
                  }
    ...
    value: function render() {
      ...
      if (projects.length > 0) {
        ...
        projects.map(function (e) {
          if (i < 6) {
            movieItems.push(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
            ...
            }, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_list_project__["a" /* default */], {
              project: e,
              __source: {
                fileName: _jsxFileName,
                lineNumber: 77
      ...
      if (data.project_count > 6) {
        moreProject.push(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
        ...
        }, "Xem th\xEAm ", __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("span", {
      ...
      }, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_provider_sidebar__["a" /* default */], {
        provider: provider,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 93
      ...
      }, data.project_count, " D\u1EF1 \xE1n ", __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("span", {
      ...
      }, movieItems, moreProject))), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
        className: "row mt-3",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 131

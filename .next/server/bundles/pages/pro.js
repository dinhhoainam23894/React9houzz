...
function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      }, project.count_image ? "+ " + project.count_image : '')), _react.default.createElement(_reactLazyload.default, {
        once: true,
        offset: [-200, 0],
        placeholder: _react.default.createElement(_PlaceHolder.default, {
...
var _link = _interopRequireDefault(__webpack_require__(35));
...
var _provider = _interopRequireDefault(__webpack_require__(65));
  ...
  _createClass(Pro, null, [{
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee(_ref) {
        var query, req, res, data, resProject, dataProject;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:

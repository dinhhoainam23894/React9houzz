...
var _Breadcrumbs = _interopRequireDefault(__webpack_require__(32));
...
var _listProvider = _interopRequireDefault(__webpack_require__(43));
...
var path_name = "danh-sach-chuyen-gia/";
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return fetch(APIURL + path_name + encodeURIComponent(query.slug) + "?page=".concat(query.page));
              ...
              case 9:
                _context.next = 11;
                return fetch(APIURL + path_name + encodeURIComponent(query.slug));

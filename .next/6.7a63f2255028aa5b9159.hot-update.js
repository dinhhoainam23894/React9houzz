...
function (_React$Component) {
  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      console.log(this.props.ideaParams); // if(this.props.isImage==true && this.props.isImage){
      //     Router.pushRoute(`/anh/${id}-${slug}`,`/anh/${nextId}-${nextSlug}`)
      // }else{
      //     // Router.push(`${this.props.currentpath}?photoId=${id}`,`/anh/${nextId}-${nextSlug}`)
      // }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=6.7a63f2255028aa5b9159.hot-update.js.map
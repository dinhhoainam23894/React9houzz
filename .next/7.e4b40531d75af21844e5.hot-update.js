    ...
    value: function showPhoto(e, id, slug) {
      ...
      if (this.props.ideaParams) {
        ...
        if (this.props.subParams) {
          ...
          _routes.Router.push("".concat(currentPath).concat(params, "?f=").concat(this.props.subParams, "&photoId=").concat(id, "&slug=").concat(slug), "/anh/".concat(id, "-").concat(slug));
        } else {
...
//# sourceMappingURL=7.e4b40531d75af21844e5.hot-update.js.map
  ...
  function Image(props) {
          ...
          return _regenerator.default.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 7:
                  _this.pushStateUrl(nextImage.id, nextImage.slug); // Router.push(`${this.props.currentPath}?photoId=${nextImage.id}`,`/anh/${nextImage.id}-${nextImage.slug}`)
                  // Router.push(`/$idea?photoId=${nextImage.id}&id=${nextImage.id}&slug=${nextImage.slug}`,`/anh/${nextImage.id}-${nextImage.slug}`)
    ...
    Object.defineProperty(_assertThisInitialized(_this), "nextProject", {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee5(id, slug) {
...
//# sourceMappingURL=6.d2664647468faa086d6d.hot-update.js.map
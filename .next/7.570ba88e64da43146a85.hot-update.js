          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return fetch(APIURL + 'danh-sach-du-an/' + encodeURIComponent(query.params) + "?f=".concat(query.f));
              ...
              case 8:
                _context.next = 10;
                return fetch(APIURL + 'danh-sach-du-an/' + encodeURIComponent(query.params));
...
//# sourceMappingURL=7.570ba88e64da43146a85.hot-update.js.map
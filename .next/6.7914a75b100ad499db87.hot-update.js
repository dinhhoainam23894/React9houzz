...
function (_React$Component) {
          ...
          return _regenerator.default.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 8:
                  _routes.Router.push("".concat(_this.props.currentPath, "?photoId=").concat(nextImage.id), "/anh/".concat(nextImage.id, "-").concat(nextImage.slug)); // Router.push(`/$idea?photoId=${nextImage.id}&id=${nextImage.id}&slug=${nextImage.slug}`,`/anh/${nextImage.id}-${nextImage.slug}`)
                  // Router.pushRoute('image', {id : nextImage.id ,slug: nextImage.slug})
  ...
  _createClass(Image, [{
    ...
    key: "pushState",
    value: function pushState(id, slug) {
      if (this.props.ideaParams) {
        var params = this.props.ideaParams;

        if (this.props.subParams) {
          _routes.Router.pushRoute("".concat(currentPath, "/").concat(params, "?f=").concat(this.props.subParams, "&photoId=").concat(id, "&slug=").concat(slug), "/anh/".concat(id, "-").concat(slug));
        } else {
...
//# sourceMappingURL=6.7914a75b100ad499db87.hot-update.js.map
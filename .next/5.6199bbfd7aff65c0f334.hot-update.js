...
function (_React$Component) {
  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      console.log(id, slug, nextId, nextSlug, this.props.isImage);

      if (this.props.isImage == true && this.props.isImage) {// Router.pushRoute(`/anh/${id}-${slug}`,`/anh/${nextId}-${nextSlug}`)
      } else {// Router.push(`${this.props.path}?photoId=${id}&id=${this.state.project.id}`,`/anh/${nextId}-${nextSlug}`)
        }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=5.6199bbfd7aff65c0f334.hot-update.js.map
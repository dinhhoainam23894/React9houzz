              ...
              switch (_context8.prev = _context8.next) {
                ...
                case 3:
                  ...
                  return _axios.default.get(url).then(function (response) {
                    ...
                    _this.getValue(nextImage.id); // this.$router.push({name: 'image.detail', params: {id: nextImage[0] , name : nextImage[1]}});
...
//# sourceMappingURL=7.563d815acc5a922d36a9.hot-update.js.map
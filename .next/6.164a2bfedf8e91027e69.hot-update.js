            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  _routes.Router.push("/images?id=".concat(id), "/anh/".concat(nextId, "-").concat(nextSlug));
            ...
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  ...
                  _routes.Router.pushRoute("/anh/".concat(nextId, "-").concat(nextSlug));

                  _routes.Router.push("/anh/".concat(id, "-").concat(slug), "/anh/".concat(nextId, "-").concat(nextSlug));
...
//# sourceMappingURL=6.164a2bfedf8e91027e69.hot-update.js.map
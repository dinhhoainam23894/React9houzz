  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      ...
      if (this.props.isImage == true && this.props.isImage) {
        ...
        console.log('ok'); // Router.push(`${this.props.path}?photoId=${id}&id=${this.state.project.id}`,`/anh/${nextId}-${nextSlug}`)
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=5.e1d983654feaf04b0b1e.hot-update.js.map
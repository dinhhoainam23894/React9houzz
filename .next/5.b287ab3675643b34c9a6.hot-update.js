  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      ...
      if (this.props.isImage == true && this.props.isImage) {
        ...
        console.log(this.props.currentPath); // Router.push(`${this.props.path}?photoId=${id}`,`/anh/${nextId}-${nextSlug}`)
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=5.b287ab3675643b34c9a6.hot-update.js.map
    ...
    value: function pushStateUrl(id, slug) {
      if (this.props.ideaParams) {
        ...
        if (this.props.subParams) {
          ...
          console.log(thiss.porps); // Router.push(`${this.props.currentPath}?params=${params}&photoId=${id}&slug=${slug}`,`/anh/${id}-${slug}`)
        }
      } else {
...
//# sourceMappingURL=7.817f765abbd3f7705524.hot-update.js.map
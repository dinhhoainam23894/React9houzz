    ...
    value: function pushStateUrl(id, slug) {
      if (this.props.ideaParams) {
        ...
        if (this.props.subParams) {
          console.log(thiss.props); // Router.push(`${this.props.currentPath}?params=${params}&f=${this.props.subParams}&photoId=${id}&slug=${slug}`,`/anh/${id}-${slug}`)
        } else {
          console.log(thiss.props); // Router.push(`${this.props.currentPath}?params=${params}&photoId=${id}&slug=${slug}`,`/anh/${id}-${slug}`)
        }
      } else {
...
//# sourceMappingURL=7.738ae0d9cfd8a05d39a8.hot-update.js.map
  ...
  function Image(props) {
                ...
                case 0:
                  ...
                  if (_this.state.detail == false) {
                    ...
                    _jquery.default.each(_this.state.listIdea, function ($key, $value) {
                      if ($value.id == _assertThisInitialized(_this), state.currentValue.id) {
                        startIndex = $key;

                        _this.nextIdea(startIndex);
                      }
                    });
                  }
    ...
    Object.defineProperty(_assertThisInitialized(_this), "nextIdea", {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee3(startIndex) {
          var currentIndex, nextImage;
          return _regenerator.default.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  console.log(id, _this.state.listIdea);
                  currentIndex = 0;
          ...
          return _regenerator.default.wrap(function _callee8$(_context8) {
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  _context8.t0 = func;
                  _context8.next = _context8.t0 === 'next' ? 3 : 6;
                  break;
                ...
                case 5:
                  return _context8.abrupt("break", 6);
...
//# sourceMappingURL=6.979b2e478f4d70f1facb.hot-update.js.map
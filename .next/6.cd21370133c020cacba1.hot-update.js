            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  _routes.Router.push("/project?photoId=".concat(id, "&id=").concat(_this.props.project.id), "/anh/".concat(nextId, "-").concat(nextSlug));
...
//# sourceMappingURL=6.cd21370133c020cacba1.hot-update.js.map
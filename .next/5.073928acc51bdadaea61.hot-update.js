  ...
  _createClass(_default, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _jquery.default)('.header-menu .nav-item').click(function (e) {
        (0, _jquery.default)(this).find('.nav-child').css("cssText", "height: 650px !important;");
        console.log((0, _jquery.default)(this).find('.nav-child'));
...
//# sourceMappingURL=5.073928acc51bdadaea61.hot-update.js.map
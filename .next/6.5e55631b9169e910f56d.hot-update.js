      ...
      switch (func) {
        case 'next':
          _axios.default.get(url).then(function (response) {
            ...
            var currentIndex = 0;
            var nextImage = _this3.state.listIdea[currentIndex];
            console.log(nextImage); // this.$router.push({name: 'image.detail', params: {id: nextImage[0] , name : nextImage[1]}});
...
//# sourceMappingURL=6.5e55631b9169e910f56d.hot-update.js.map
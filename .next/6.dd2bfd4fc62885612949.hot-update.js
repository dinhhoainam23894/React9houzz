  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      if (this.props.isImage == true && this.props.isImage) {
        ...
        _routes.Router.push("".concat(this.props.currentPath, "?photoId=").concat(id, "&id=").concat(this.state.project.id, "&slug=").concat(this.state.project.slug), "/anh/".concat(nextId, "-").concat(nextSlug));
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=6.dd2bfd4fc62885612949.hot-update.js.map
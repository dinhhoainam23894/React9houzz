...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__libraries_helpers__ = __webpack_require__("./libraries/helpers.js");
...
function (_Component) {
  ...
  _createClass(Project, [{
    ...
    value: function showPhoto(e, id, slug) {
      e.preventDefault();
      __WEBPACK_IMPORTED_MODULE_7_next_router___default.a.push("/project?id=".concat(this.props.id, "&photoId=").concat(id, "&slug=").concat(slug), "/anh/".concat(id, "-").concat(slug));
    }
  }, {
    key: "dismissModal",
    value: function dismissModal(id, slug) {
      __WEBPACK_IMPORTED_MODULE_7_next_router___default.a.push("/du-an/".concat(id, "-").concat(slug));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_pro_detail__["a" /* default */], {
      ...
      }, " ", this.state.project.source_url)), this.state.project.more_infos && Object(__WEBPACK_IMPORTED_MODULE_6__libraries_helpers__["a" /* mapObject */])(this.state.project.more_infos, function (index, value) {
        ...
        }, Object(__WEBPACK_IMPORTED_MODULE_6__libraries_helpers__["c" /* ucfirst */])(index), " "), " : ", value);
...
//# sourceMappingURL=5.d7bbe309c2bb8ace819d.hot-update.js.map
    ...
    Object.defineProperty(_assertThisInitialized(_this), "nextIdea", {
      ...
      value: function () {
        ...
        _regenerator.default.mark(function _callee3() {
          var id, startIndex, currentIndex, nextImage;
          return _regenerator.default.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  id = _this.state.currentValue.id;
                  console.log(id);
                  startIndex = 0;
                  currentIndex = 0;
                  ...
                  console.log(currentIndex, _this.state.listIdea.length);
...
//# sourceMappingURL=6.c698700433b70bd4657d.hot-update.js.map
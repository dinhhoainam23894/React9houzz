...
function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _jquery.default)('.header-menu a.nav-link').click(function (e) {
        (0, _jquery.default)(this).find('.collapse').$('.StoreNavigation-overlay').addClass('is-open');
      });
    }
  }, {
    key: "toggleModal",
...
//# sourceMappingURL=6.200f0ffcbea42007a2e6.hot-update.js.map
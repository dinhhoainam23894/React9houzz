  ...
  _createClass(Image, [{
    ...
    value: function pushStateProject(id, slug, nextId, nextSlug) {
      if (this.props.isImage == true && this.props.isImage) {
        ...
        console.log(this.props); // Router.push(`${this.props.currentPath}?photoId=${id}&id=${this.state.project.id}`,`/anh/${nextId}-${nextSlug}`)
      }
    }
  }, {
    key: "render",
...
function (_React$PureComponent) {
  ...
  _createClass(ImageInfo, [{
    ...
    value: function changeImage(e, value) {
      console.log(this.props.image.slug);
      e.preventDefault();
...
//# sourceMappingURL=7.80c3d3a26151cef55387.hot-update.js.map
                                ...
                                <div className="link_widgets">
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <Link route='/about/gioi-thieu'><a href="#" target="_blank" title="Giới thiệu">Giới thiệu</a></Link>
                                            <a href="#" title="Liên hệ" rel="nofollow">Liên hệ</a>
                                            <Link route='/about/chinh-sach-bao-mat'><a href="#" target="_blank" title="Chính sách bảo mật">Chính sách bảo mật</a></Link>
                                            <Link route='/about/dieu-khoan-su-dung'><a href="#" target="_blank" title="Điều khoản sử dụng">Điều khoản sử dụng</a></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>

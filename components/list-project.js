                    ...
                    <div className="rounded-2 border provider-project">
                        <div className="row project position-relative mx-auto">
                            ...
                            <div className="position-absolute h-100 w-100 bg-secondary first-image">
                              <LazyLoad once offset={[-200, 0]} placeholder={<Placeholder dataSrc={this.props.project.avatar && this.props.project.avatar[0]} alt={this.props.project && this.props.project.name}/>}  debounce={0}>
                            ...
                            <div className="position-absolute h-48 ml-1 mb-1 bg-secondary second-image right-avatar">
                              <LazyLoad once offset={[-200, 0]} placeholder={<Placeholder dataSrc={this.props.project.avatar && this.props.project.avatar[1]} alt={this.props.project && this.props.project.name}/>}  debounce={0}>
                            ...
                            <div className="position-absolute h-50 ml-1 third-image bg-secondary right-avatar">
                              ...
                              <LazyLoad once offset={[-200, 0]} placeholder={<Placeholder dataSrc={this.props.project.avatar && this.props.project.avatar[2]} alt={this.props.project && this.props.project.name}/>}  debounce={0}>
